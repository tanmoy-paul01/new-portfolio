    ...
    useEffect(() => {
        ...
        window.addEventListener('scroll', () => {
            if (scrollY > 50) {
                ...
                navLinkRef.current.classList.add('bg-white', 'shadow-sm', 'bg-opacity-50', 'dark:border', 'dark:border-green-500/30', "dark:bg-transparent");
            }
        })
        ...
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-sm px-12 py-3 bg-white shadow-md border border-gray-200 bg-opacity-50 font-Ovo dark:border dark:border-green-500/30 dark:bg-transparent ">
                    ...
                    <li><a className='hover:text-blue-500 dark:hover:text-[#1EFF00] transition' href="#work">My Work</a></li>
                    <li><a className='hover:text-blue-500 dark:hover:text-[#1EFF00] transition' href="#contact">Contact me</a></li>
                </ul>
