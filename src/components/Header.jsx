export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px]">Full Stack <span className="dark:text-[#1EFF00] text-blue-500">Web</span> Developer</h1>
            <p className="max-w-2xl mx-auto">Building scalable web apps with MERN, Java & SQL — turning real-world problems into elegant digital solutions.</p>
